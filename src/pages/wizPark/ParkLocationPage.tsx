    ...
    >
      <div className="flex flex-col items-center text-wiz-white">
        ...
        <div className="flex flex-col items-center my-8 gap-2 break-keep md:text-xl ">
          ...
          <Button className="bg-wiz-white bg-opacity-10 text-wiz-white rounded-xl w-fit h-10 mt-3 flex items-center justify-center hover:bg-wiz-red hover:text-wiz-white">
            <a
