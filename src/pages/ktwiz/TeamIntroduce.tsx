  ...
  return (
    <div className="flex flex-col items-center my-20 mx-20 justify-center bg-wiz-black">
      <Breadcrumb
        paths={[
          { key: 'home', label: 'Home' },
          { key: 'wizpark', label: 'Kt wiz' },
          { key: 'suwon-kt-wizpark', label: 'Kt wiz는?' },
          { key: 'wizpark-intro', label: '구단소개', isActive: true },
        ]}
      />
      {/* biome-ignore lint/a11y/useAltText: <explanation> */}
      <img src="/assets/Ktwiz/TeamLogo.jpg" className="w-4/5 h-5/6 mt-3 mb-8" />

      <Card className="h-1/3 w-[90%] px-8 pb-8 flex flex-col justify-start border-none shadow-none text-wiz-white">
        <CardContent className="flex flex-col gap-7">
          <Card className="flex flex-col gap-3 rounded-3xl">
            <div className="m-4 flex flex-col gap-3">
              <CardTitle className="text-3xl pl-3 flex justify-center">
          ...
          <Card className="flex gap-3 rounded-3xl overflow-hidden">
            <div className="w-[65%] p-6 flex flex-col justify-start ">
              <CardTitle className="text-3xl mb-3 flex justify-center">
                명문구단을 위한 철저한 플랜!
              </CardTitle>
          ...
          <Card className="flex  rounded-3xl overflow-hidden">
            <div className="w-[70%] p-6 flex flex-col justify-start">
              <CardTitle className="text-3xl mb-3 flex justify-center">
                복합 문화공간의 첨단 야구장!
              </CardTitle>
              <CardDescription className="text-[18px] leading-relaxed">
          ...
          <Card className="flex flex-col gap-3 rounded-3xl">
            <div className="m-4 flex flex-col gap-3">
              ...
              <CardDescription className="text-xl flex flex-col justify-center">
