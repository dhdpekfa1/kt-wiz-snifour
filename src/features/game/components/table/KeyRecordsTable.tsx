...
const KeyRecordsTable = () => {
  return (
    <Table className="whitespace-nowrap">
      <TableBody>
        <TableRow>
          <TableCell className="font-medium border border-slate-200 text-center bg-wiz-white">
            결승타
          </TableCell>
          <TableCell className="font-medium border border-slate-200 w-full text-wiz-white bg-[#35383e]">
